...
export const ASSEMBLY_GRID_SCALE = 3.8;
export function assemblyPlan(tiles, seedId) {
  ...
  return tiles.map((tile, i) => {
    ...
    return { id: tile.id, center, dx: tile.crossing[0] * ASSEMBLY_GRID_SCALE - center[0], dy: tile.crossing[1] * ASSEMBLY_GRID_SCALE - center[1], delay: .7 * (levels[i] < 0 ? 1 : levels[i] / depth) };
  });
}
